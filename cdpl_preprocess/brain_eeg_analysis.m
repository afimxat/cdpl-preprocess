...
new_listbox=strvcat(listOfRawFiles);
...
for counter=1:length(historyFiles)
    aCFG=open([pathname,filesep,listOfHistoryFiles{counter}]);
...
% end
set(handles.step_list_listbox,'String',new_listbox)
